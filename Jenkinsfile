...
tasks['arm'] = { ->
    node('master') {
        try {
            ...
            final String url = "curl -s --location --request GET 'http://test.rp-ci-proxy.melifrontends.com/pipeline/3221366' --header 'x-auth-token: --header 'x-auth-token: ac3220d5f080ece307978add4d1617156f95aaf37de68546dc6e2589a26e31a6''"
